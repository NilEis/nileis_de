...
wasmBinaryFile = "n-body_mono.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker() {
  var worker;
  var pthreadMainJs = locateFile("n-body_mono.worker.js");
...
function _emscripten_set_window_title(title) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(4, 1, title);
...
var GLFW = {
 ...
 onKeyChanged: (keyCode, status) => {
  ...
  if (GLFW.active.keyFunc) {
   if (repeat) status = 2;
   ((a1, a2, a3, a4, a5) => {
    throw 'Internal Error! Attempted to invoke wasm function pointer with signature "viiiii", but no such functions have gotten exported!';
 ...
 onMouseButtonChanged: (event, status) => {
  ...
  if (GLFW.active.mouseButtonFunc) {
   ((a1, a2, a3, a4) => {
    throw 'Internal Error! Attempted to invoke wasm function pointer with signature "viiii", but no such functions have gotten exported!';
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, _fd_write, _emscripten_set_window_title, _emscripten_get_device_pixel_ratio ];
